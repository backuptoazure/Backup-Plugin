...
require_once (ABSPATH . 'wp-content'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'BackupToAzure'.DIRECTORY_SEPARATOR.'WindowAzure'.DIRECTORY_SEPARATOR.'library'.DIRECTORY_SEPARATOR.'dependencies'.DIRECTORY_SEPARATOR.'PEAR.php');
require_once(ABSPATH . 'wp-content'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'BackupToAzure'.DIRECTORY_SEPARATOR.'WindowAzure'.DIRECTORY_SEPARATOR.'library'.DIRECTORY_SEPARATOR.'dependencies'.DIRECTORY_SEPARATOR.'Mail'.DIRECTORY_SEPARATOR.'mimePart.php');
 require_once(ABSPATH . 'wp-content'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'BackupToAzure'.DIRECTORY_SEPARATOR.'WindowAzure'.DIRECTORY_SEPARATOR.'library'.DIRECTORY_SEPARATOR.'dependencies'.DIRECTORY_SEPARATOR.'Mail'.DIRECTORY_SEPARATOR.'mimeDecode.php');
